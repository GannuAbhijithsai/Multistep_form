...
export default function Page1() {
 ...
 const nextpage=()=>{
  ...
  return (
    ...
    <div  class="bg-gray-300 rounded-lg" style={{width:'80%',marginLeft:'10%',marginRight:'10%',height:'4px',position:'relative'}}>
    <div  class="rounded-lg" style={{width:'20%',backgroundColor:  '#5FB5A3',height:'4px',marginTop:'2%',position:'relative'}}></div>
    </div>
        <p class="font-bold flex justify-center " id="head11" style={{marginTop:'1%'}}>Which describes you get ?</p>
